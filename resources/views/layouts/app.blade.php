...
<div class="wrapper">
    ...
    <!-- mengisi yield('dashboard') dena -->
    <!-- @section('dashboard', 'Dashboard V1')  -->
...
<!-- jvectormap -->
<script src="{{url('assets/splugins/jvectormap/jquery-jvectormap-1.2.2.min.js')}}"></script>
